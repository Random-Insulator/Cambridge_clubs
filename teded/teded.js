// ─── CLUB THEME COLOR ─────────────────────────────────
document.documentElement.style.setProperty('--club-color',  '#e8504a');
document.documentElement.style.setProperty('--club-bg',     'rgba(232,80,74,0.1)');
document.documentElement.style.setProperty('--club-border', 'rgba(232,80,74,0.2)');

// ─── CAROUSEL & ACTIVITIES — loaded from API ──────────
const API_BASE = '';
const CLUB_ID  = 'teded';

const phIcon = `<svg viewBox="0 0 24 24" fill="none" stroke="#e8504a" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>`;
...
// ─── MEMBERS ──────────────────────────────────────────
const members = [
  { name: "Arjun Patel", initials: "AP" },
  { name: "Mei Lin", initials: "ML" },
  { name: "Samuel Osei", initials: "SO" },
  { name: "Fatima Zahra", initials: "FZ" },
  { name: "Oliver Webb", initials: "OW" },
  { name: "Nadia Kowalski", initials: "NK" },
];
