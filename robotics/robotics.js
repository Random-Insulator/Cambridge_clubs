// ─── CLUB THEME COLOR ─────────────────────────────────
document.documentElement.style.setProperty('--club-color',  '#3b9cf5');
document.documentElement.style.setProperty('--club-bg',     'rgba(59,156,245,0.1)');
document.documentElement.style.setProperty('--club-border', 'rgba(59,156,245,0.2)');

// ─── CAROUSEL & ACTIVITIES — loaded from API ──────────
const API_BASE = '';
const CLUB_ID  = 'robotics';

const phIcon = `<svg viewBox="0 0 24 24" fill="none" stroke="#3b9cf5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>`;
...
const members = [
  ...
  { name: "Jessica Park", initials: "JP" },
  { name: "Marco Russo", initials: "MR" },
  { name: "Amara Diallo", initials: "AD" },
  { name: "Ben Hartley", initials: "BH" },
  { name: "Leila Mansour", initials: "LM" },
];
