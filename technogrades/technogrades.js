// ─── CLUB THEME COLOR ─────────────────────────────────
document.documentElement.style.setProperty('--club-color',  '#f97316');
document.documentElement.style.setProperty('--club-bg',     'rgba(249,115,22,0.1)');
document.documentElement.style.setProperty('--club-border', 'rgba(249,115,22,0.2)');

// ─── CAROUSEL & ACTIVITIES — loaded from API ──────────
const API_BASE = '';
const CLUB_ID  = 'Technocrates';

const phIcon = `<svg viewBox="0 0 24 24" fill="none" stroke="#f97316" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>`;
...
// ─── MEMBERS ──────────────────────────────────────────
const members = [
  { name: "Ryan O'Brien", initials: "RO" },
  { name: "Meera Pillai", initials: "MP" },
  { name: "Josh Kamara", initials: "JK" },
  { name: "Nina Volkova", initials: "NV" },
  { name: "Hassan Al-Amin", initials: "HA" },
