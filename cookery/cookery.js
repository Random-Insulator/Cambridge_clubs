// ─── CLUB THEME COLOR ─────────────────────────────────
document.documentElement.style.setProperty('--club-color',  '#f59e3b');
document.documentElement.style.setProperty('--club-bg',     'rgba(245,158,59,0.1)');
document.documentElement.style.setProperty('--club-border', 'rgba(245,158,59,0.2)');

// ─── CAROUSEL & ACTIVITIES — loaded from API ──────────
const API_BASE = '';
const CLUB_ID  = 'cookery';

const phIcon = `<svg viewBox="0 0 24 24" fill="none" stroke="#f59e3b" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>`;
...
const members = [
  ...
  { name: "Yusuf Ibrahim", initials: "YI" },
  { name: "Caitlin Murphy", initials: "CM" },
  { name: "Riya Shah", initials: "RS" },
  { name: "Alex Turner", initials: "AT" },
  { name: "Diya Menon", initials: "DM" },
];
