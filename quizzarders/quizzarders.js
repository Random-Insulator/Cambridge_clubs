// ─── CLUB THEME COLOR ─────────────────────────────────
document.documentElement.style.setProperty('--club-color',  '#22c97a');
document.documentElement.style.setProperty('--club-bg',     'rgba(34,201,122,0.1)');
document.documentElement.style.setProperty('--club-border', 'rgba(34,201,122,0.2)');

// ─── CAROUSEL & ACTIVITIES — loaded from API ──────────
const API_BASE = '';
const CLUB_ID  = 'quizzarders';

const phIcon = `<svg viewBox="0 0 24 24" fill="none" stroke="#22c97a" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>`;
...
// ─── MEMBERS ──────────────────────────────────────────
const members = [
  { name: "Siddharth Rao", initials: "SR" },
  { name: "Emma Fitzgerald", initials: "EF" },
  { name: "Callum Black", initials: "CB" },
  { name: "Anaya Williams", initials: "AW" },
  { name: "Felix Strauss", initials: "FS" },
  { name: "Divya Kumar", initials: "DK" },
];
