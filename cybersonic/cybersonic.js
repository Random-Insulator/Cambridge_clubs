// ─── CLUB THEME COLOR ─────────────────────────────────
document.documentElement.style.setProperty('--club-color',  '#7c6ef7');
document.documentElement.style.setProperty('--club-bg',     'rgba(124,110,247,0.1)');
document.documentElement.style.setProperty('--club-border', 'rgba(124,110,247,0.2)');

// ─── CAROUSEL & ACTIVITIES — loaded from API ──────────
const API_BASE = ''; // relative to same origin

const CLUB_ID  = 'cybersonic';

const phIcon = `<svg viewBox="0 0 24 24" fill="none" stroke="#7c6ef7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>`;
...
// ─── MEMBERS ──────────────────────────────────────────
const members = [
  { name: "Moulik Jain",      initials: "RM" },
  { name: "Atharva Agarwal",    initials: "IF" },
  { name: "Garv Juneja",     initials: "KA" },
  { name: "Arav Gupta",     initials: "ZH" },
  { name: "Yagyansh Jain",   initials: "NL" },
];
