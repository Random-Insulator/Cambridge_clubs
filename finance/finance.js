// ─── CLUB THEME COLOR ─────────────────────────────────
document.documentElement.style.setProperty('--club-color',  '#06b6d4');
document.documentElement.style.setProperty('--club-bg',     'rgba(6,182,212,0.1)');
document.documentElement.style.setProperty('--club-border', 'rgba(6,182,212,0.2)');

// ─── CAROUSEL & ACTIVITIES — loaded from API ──────────
const API_BASE = '';
const CLUB_ID  = 'finance';

const phIcon = `<svg viewBox="0 0 24 24" fill="none" stroke="#06b6d4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>`;
...
// ─── MEMBERS ──────────────────────────────────────────
const members = [
  { name: "Vikram Singhania", initials: "VS" },
  { name: "Lucy Chen", initials: "LC" },
  { name: "Daniel Okafor", initials: "DO" },
  { name: "Sophia Reeves", initials: "SR" },
  { name: "Adam Hassan", initials: "AH" },
  { name: "Tara Iyer", initials: "TI" },
];
